...
int DoServer(const std::string& db_path, uint16_t rpc_port, uint16_t p2p_port, const std::string& seed_ip, uint16_t seed_port) {
  ...
  connOptions.DoAccept = std::bind(&ambr::syn::Impl::OnAcceptNode, p_syn_manager.get(), std::placeholders::_1);
  connOptions.DoConnect = std::bind(&ambr::syn::Impl::OnConnectNode, p_syn_manager.get(), std::placeholders::_1);
  connOptions.DoDisConnect = std::bind(&ambr::syn::Impl::OnDisConnectNode, p_syn_manager.get(), std::placeholders::_1);
